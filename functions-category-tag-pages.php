<?php
/*
  Denna inkluderas av functions, då temat behöver detta
  för att kunna ha olika sidfötter på olika sidor beorende på taggar.
*/

/*
ZPlugin Name: Category Tag Pages
ZPlugin URI: http://technotes.marziocarro.com/
ZDescription: Adds categories and tags functionality for your pages.
ZVersion: 1.0
ZAuthor: Marzio Carro
ZAuthor URI: http://marziocarro.com/
ZLicense: GPLv3 or later
